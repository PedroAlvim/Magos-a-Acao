...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(635, 370));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/magosminegame/imagens/mago.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 48)); // NOI18N
        jLabel3.setText("MAGOS A AÇÃO");
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        Creditos i = new Creditos();
        i.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton5MouseClicked

    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        InterfaceJogo i = new InterfaceJogo();
        i.setVisible(true); 
        dispose();
    }//GEN-LAST:event_jButton4MouseClicked

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ComoJoga i = new ComoJoga();
        i.setVisible(true);
        dispose();
